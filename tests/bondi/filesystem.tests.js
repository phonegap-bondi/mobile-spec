Tests.prototype.FilesystemTests = function() {	
    ...
    test("should be able to instantiate a File object with properties from default documents location", function () {
        expect(12);
        var file = bondi.filesystem.resolve(bondi.filesystem.getDefaultLocation("documents"));
    ...
    test("should be able to instantiate a FileStream object with properties by opening or resolving a created file", function () {
        expect(12);
        var documentsLocation = bondi.filesystem.resolve(bondi.filesystem.getDefaultLocation("documents"));
